...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 30, 2024 at 10:34 AM
...
--
-- Table structure for table `customer_product_dollarsales`
--

DROP TABLE IF EXISTS `customer_product_dollarsales`;
CREATE TABLE IF NOT EXISTS `customer_product_dollarsales` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `customerName` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dollar_sales` int(11) NOT NULL,
...
--
-- Dumping data for table `customer_product_dollarsales`
--

INSERT INTO `customer_product_dollarsales` (`id`, `customerName`, `dollar_sales`, `created_at`, `updated_at`) VALUES
(1, 'Euro+ Shopping Channel', 820690, NULL, NULL),
(2, 'Mini Gifts Distributors Ltd.', 591827, NULL, NULL),
(3, 'Australian Collectors, Co.', 180585, NULL, NULL),
(4, 'Muscle Machine Inc', 177914, NULL, NULL),
(5, 'La Rochelle Gifts', 158573, NULL, NULL),
(6, 'Dragon Souveniers, Ltd.', 156251, NULL, NULL),
(7, 'Down Under Souveniers, Inc', 154622, NULL, NULL),
(8, 'Land of Toys Inc.', 149085, NULL, NULL),
(9, 'AV Stores, Co.', 148410, NULL, NULL),
(10, 'The Sharp Gifts Warehouse', 143536, NULL, NULL);
...
(5, '2019_07_09_073559_create_customer_product_dollarsales_table', 2),
(6, '2024_05_30_093453_create_orders_table', 3),
(7, '2024_05_30_093832_create_orderdetails_table', 3),
(8, '2024_05_30_093908_create_customers_table', 3);
...
(1, 'John Doe', 'john@doe.com', NULL, '$2y$10$5hR/E/BD4SaklmCrDjKmv.jHL0vX1KsKS/dIF9sqrgmZs2LkNgjXG', NULL, NULL, NULL),
(2, 'Jane Doe', 'jane@doe.com', NULL, '$2y$10$MyL.ztZxJ9EWaeLfuDvcwO6sOIbaUSIAYW0ojeLm.UqxzYLqry5Yi', NULL, NULL, NULL),
(3, 'Jin Doe', 'jin@doe.com', NULL, '$2y$10$lPfYsDPELHrf.xg3/Z.2sOFI.So3C1UwXVn0O6Pt6/XNbW58NAa/e', NULL, NULL, NULL);
